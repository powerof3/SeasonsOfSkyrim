...
void SeasonManager::LoadSettings()
{
	...
	INI::get_value(ini, ignoreMainWINFormSwap, "Settings", "Ignore auto generated WIN formswap", ";Autogenerated winter formswap config will not be applied");
