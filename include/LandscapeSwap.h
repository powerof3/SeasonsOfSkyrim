...
namespace LandscapeSwap
{
	namespace Texture
	{
		...
		inline void Install()
		{
			...
			constexpr std::array<std::uint64_t, 3> offsets{ 0x174, 0x18D, 0x1E6 };
		...
		namespace Alt
		{
			...
			inline void Install()
			{
				constexpr std::array targets{
					std::make_pair(15372, 0x2F5),  // add_cell_grass
					std::make_pair(15373, 0x597),  // add_cell_grass_from_buffer
					std::make_pair(15374, 0x25C),  // add_cell_grass_from_file
				};
